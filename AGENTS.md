...
- В русскоязычной документации сервис называй «ПланФикс». Исключение — технические
  идентификаторы: `PLANFIX_*`, `planfix-mcp`, `PlanfixMCP`, `planfix.com` и URL.
- Не модифицируй репозитории в /home/alexd/Project/ai (только чтение); рабочий код — здесь, в PlanfixMCP

## Работа с данными ПланФикс (контекст LLM)
